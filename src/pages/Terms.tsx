      ...
      <ContLayout>
        <div className="container">
          <div className="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sunny Side Up, 16 Collyer Quay, 17-00,
                  049318.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  ...
                  <Link to="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Sunny Side Up, accessible from{' '}
                  <Link to="https://www.sunnysideup.finance/" rel="external nofollow noopener" target="_blank">
                    https://www.sunnysideup.finance/
                  </Link>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: officialsunnysideup72@gmail.com</li>
            </ul>
          </div>
        </div>
      </ContLayout>
